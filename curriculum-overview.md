...
Phase 1: 에이전트 구축    Phase 3: 멀티 에이전트          Phase 5: 배포
 └ 상담 에이전트            └ Triage/Analysis/Rec.        └ AWS 배포
 └ Runtime 배포             └ Supervisor Agent            └ 체크리스트
                            └ 컨텍스트 엔지니어링
Phase 2: 도구 + 운영       └ 프롬프트 캐시             팀별 발표 + 수료
 └ 혈액검사 도구
 └ Memory (STM/LTM)      Phase 4: 보안 + 평가
...
| 12:00-13:00 | **점심** | - |
| 13:00-13:15 | 컨텍스트 엔지니어링 + 프롬프트 캐시 개념 | 이론 |
| 13:15-13:45 | **Phase 3-C**: 컨텍스트 엔지니어링 + 프롬프트 캐시 적용 | 실습 |
| 13:45-14:10 | AgentCore Policy + Bedrock Guardrails 개념 | 이론 |
...
Day 1-2에서 구축한 전체 시스템을 AWS 프로덕션 환경에 배포하고, Agentic AI 애플리케이션 배포 체크리스트로 운영 준비를 완료합니다. 마지막으로 팀별 발표를 통해 아키텍처, 보안 대응, 실무 적용 고려사항을 공유하고 피드백을 받습니다.

| 시간 | 내용 | 유형 |
|------|------|------|
| 09:00-09:10 | Day 1-2 리캡 + 체크포인트 코드 배포 | 리뷰 |
| 09:10-09:20 | Agentic AI 프로덕션 배포 체크리스트 소개 | 이론 |
| 09:20-10:40 | **Phase 5**: AWS 배포 + 프로덕션 체크리스트 완료 | 실습 |
| 10:50-12:00 | 팀별 산출물 발표 (10분 발표 + 5분 Q&A) | 발표 |
| 12:00-12:30 | 실무 적용 주의사항 + Next Steps + 수료 | 클로징 |

**Day 3 산출물**: 프로덕션 Ready 시스템 + 최종 발표 + 수료
